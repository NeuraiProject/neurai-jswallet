import {getRPC as $jLKws$getRPC, methods as $jLKws$methods} from "@neuraiproject/neurai-rpc";
import $jLKws$neuraiprojectneuraikey from "@neuraiproject/neurai-key";
import $jLKws$neuraiprojectneuraisigntransaction from "@neuraiproject/neurai-sign-transaction";
...
function $fab42eb3dee39b5b$export$2e2262a44ac61957(originalArray) {
    const uniqueArray = [];
    const seen = new Set();
...
class $c7db79d953d79f02$export$a0aa368c31ae6e6c {
   ...
   */ getForcedUTXOs() {
    ...
    async loadData() {
        ...
        this._allUTXOs = (0, $fab42eb3dee39b5b$export$2e2262a44ac61957)(allUTXOs);
    }
    getAmount() {
        let total = 0;
...
(0, $jLKws$neuraiprojectneuraisigntransaction).sign; //"Idiocracy" but prevents bundle tools such as PARCEL to strip this dependency out on build.
...
async function $67c46d86d9d50c48$export$322a62cff28f560a(WIF, wallet, onlineMode) {
    ...
    const signedHex = (0, $jLKws$neuraiprojectneuraisigntransaction).sign(wallet.network, rawHex, UTXOs, privateKeys);
...
class $c3dba3dbad356cd6$export$febc5573c75cefb0 {
    constructor(options){
        ...
        this.sendManyTransaction = new (0, $c7db79d953d79f02$export$a0aa368c31ae6e6c)(_options);
    }
    getWalletMempool() {
...
async function $2767f256fef0b24e$export$df96cd8d56be0ab1(wallet, addresses) {
    ...
    const balance = await wallet.rpc((0, $jLKws$methods).getaddressbalance, params);
...
const $14d29c831c740206$var$URL_EVRMORE_MAINNET = "https://evr-rpc-mainnet.ting.finance/rpc";
class $14d29c831c740206$export$bcca3ea514774656 {
   ...
   */ sweep(WIF, onlineMode) {
    ...
    async init(options) {
        ...
        let url = $14d29c831c740206$var$URL_NEURAI_MAINNET;
        //VALIDATION
        ...
        if (options.network === "evr") url = $14d29c831c740206$var$URL_EVRMORE_MAINNET;
    ...
    async hasHistory(addresses) {
        ...
        const asdf = await this.rpc((0, $jLKws$methods).getaddressbalance, [
            obj,
            includeAssets
        ]);
        //@ts-ignore
    ...
    async getHistory() {
        ...
        const deltas = this.rpc((0, $jLKws$methods).getaddressdeltas, [
            {
                addresses: addresses,
                assetName: assetName
            }
    ...
    async getMempool() {
        const method = (0, $jLKws$methods).getaddressmempool;
        const includeAssets = true;
        const params = [
            {
   ...
   */ async getAssetUTXOs(assetName) {
        ...
        return this.rpc((0, $jLKws$methods).getaddressutxos, params);
    }
    async getUTXOs() {
        return this.rpc((0, $jLKws$methods).getaddressutxos, [
            {
                addresses: this.getAddresses()
            }
        ]);
   ...
   */ async createTransaction(options) {
        ...
        const signed = (0, $jLKws$neuraiprojectneuraisigntransaction).sign(this.network, raw, transaction.getUTXOs(), privateKeys);
        try {
...
var $14d29c831c740206$export$2e2bcd8739ae039 = {
    createInstance: $14d29c831c740206$export$99152e8d49ca4e7d,
    getBaseCurrencyByNetwork: $b986b05eb12d057a$export$af0c167f1aa2328f
};
async function $14d29c831c740206$export$99152e8d49ca4e7d(options) {
    const wallet = new $14d29c831c740206$export$bcca3ea514774656();
    await wallet.init(options);
    return wallet;
}


export {$14d29c831c740206$export$bcca3ea514774656 as Wallet, $14d29c831c740206$export$2e2bcd8739ae039 as default, $14d29c831c740206$export$99152e8d49ca4e7d as createInstance, $c3dba3dbad356cd6$export$febc5573c75cefb0 as Transaction, $c7db79d953d79f02$export$a0aa368c31ae6e6c as SendManyTransaction};
